...
def encode_features():
    ...
    logging.info('********* Insie encode_features ************* ')
    ...
    logging.info('********* df_placeholder.columns ***********')
    logging.info(df_placeholder.columns)
    ...
    logging.info('********* df_encoded.columns to be saved ***********')
    logging.info(df_encoded.columns)

    # save the features and target in separate tables
    #df_encoded
    df_model_input.to_sql(name='features_inference', con=cnx,
...
def get_models_prediction():
    ...
    SAMPLE USAGE
        load_model()
    '''
    # Initial Log for ML Tracking and Other Information
    logging.info('********* get_models_prediction ************* ')
    logging.info(TRACKING_URI)
    
    # set the tracking uri
    mlflow.set_tracking_uri(TRACKING_URI)
    logging.info('after Tracking')
    ...
    logging.info('********* features_inference ************* ')
    ...
    # If needed will use below log 
    #logging.info('********* predicted_values ************* ')
    #logging.info(df_new_data)
    #df_new_data.to_csv('df_new_data_predicted.csv', index=False)
    cnx.close()
...
def prediction_ratio_check():
    ...
    '''
    logging.info('********* prediction_ratio_check ************* ')
...
def input_features_check():
    ...
    logging.info('**********  features_inference Column Information ********** ')
